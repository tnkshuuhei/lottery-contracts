...
contract Sender is CCIPReceiver, OwnerIsCreator {
    ...
    // The message being sent - will be the EOA of the person sending tokens.
    ...
    // The borrower EOA. Should be a depositor.
    // The token amount that was sent.
        ...
        returns (bytes32 messageId)
    {
        ...
        Client.EVMTokenAmount memory tokenAmount =
            Client.EVMTokenAmount({ token: tokenToTransfer, amount: transferAmount });
