...
contract LooteryFactory is ILooteryFactory, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    bytes32 private constant RANDOMISER_SLOT = 0x7fd620ff951c5553351af243f95586d6c40fbde77386fa401565df721194304b;
    // keccak256("troops.lootery_factory.nonce");
    bytes32 private constant NONCE_SLOT = 0xb673313ff65da5deee919e9043f9d191abd6721ce5d457fcf870135fe1bceb99;
    ...
    bytes32 private constant FEE_RECIPIENT_SLOT = 0x42ca05c9d33288b41ba8de79367abafbc42de97cbc0b0b65f9ad198e935fb6b7;
    ...
    function init(address looteryMasterCopy, address randomiser, address ticketSVGRenderer) public initializer {
    ...
    function setLooteryMasterCopy(address looteryMasterCopy) external onlyRole(DEFAULT_ADMIN_ROLE) {
        address oldLooteryMasterCopy = LOOTERY_MASTER_COPY_SLOT.getAddressSlot().value;
        LOOTERY_MASTER_COPY_SLOT.getAddressSlot().value = looteryMasterCopy;
    ...
    function setRandomiser(address randomiser) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function setTicketSVGRenderer(address ticketSVGRenderer) external onlyRole(DEFAULT_ADMIN_ROLE) {
        address oldTicketSVGRenderer = TICKET_SVG_RENDERER_SLOT.getAddressSlot().value;
        TICKET_SVG_RENDERER_SLOT.getAddressSlot().value = ticketSVGRenderer;
    ...
    function setFeeRecipient(address feeRecipient) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function computeNextAddress() external view returns (address) {
        ...
        return Clones.predictDeterministicAddress(LOOTERY_MASTER_COPY_SLOT.getAddressSlot().value, salt);
    }
